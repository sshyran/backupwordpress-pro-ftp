...
$container['admin'] = function( $container ) {
	return new $container['checklicense_class']( $container['addon_settings_key'],$container['addon_settings_defaults'], $container['edd_download_file_name'], $container['addon'], $container['prefix'] );
};
